(function ($) {
        ...
        function custom_code() {
            let about_me_btn = document.querySelector( '#about_me_hero_btn' ),
                dsn_about_link = document.querySelector( '.dsn-paginate-right-page .dsn-link-paginate' ).firstChild;
            ...
            return {
                ajaxLoad: function () {
                    ...
                    this.ajaxClick.on("click", function (e) {
                        ...
                        if( this.ajaxClick.length && ( this.ajaxClick.attr( 'ignore-dsn' ) == 'true' ) ) {
                            return;
                        }
